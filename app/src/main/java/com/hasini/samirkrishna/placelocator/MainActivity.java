package com.hasini.samirkrishna.placelocator;
...
import android.view.MenuItem;import android.annotation.SuppressLint;
...
public class MainActivity extends FragmentActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            i.setData(Uri.parse("https://play.google.com/store/apps/details?id=com.has.chsamirkrishna.medigo"));
            startActivity(i);
            Toast.makeText(MainActivity.this,"redirecting to MediGO ",Toast.LENGTH_LONG).show();
    ...
    private String getUrl(double latitude , double longitude , String nearbyPlace)
    {
        ...
        googlePlaceUrl.append("&key="+"AIzaSyBWuwXeoqt85ON9064ss2M2DPerXjIp42U");
